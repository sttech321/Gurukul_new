  ...
  //********************************** the function below validating user login request 
    function validate_login() {
        ...
        if ($login_user == 'principal') {
            // $this->session->set_flashdata('flash_message', 'Welcome to the Principal Dashboard!');
            redirect(base_url('principal/dashboard'), 'refresh'); // Redirect to principal/dashboard
        }
