                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <input type="hidden" name="gurukul_id"
                                value="<?php echo isset($teacher['gurukul_id']) ? $teacher['gurukul_id'] : ''; ?>">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="number" class="form-control" id="father_aadhaar" name="father_aadhaar"
                                        value="" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="number" class="form-control" id="mother_aadhaar" name="mother_aadhaar"
                                        value="" required>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#"
                                        onclick="confirm_modal('<?php echo base_url();?>teacher/student/delete/<?php echo $student['student_id'];?>');"><button
                                            type="button" class="btn btn-danger btn-circle btn-xs"><i
                                                class="fa fa-times"></i></button></a>


                                    <!-- <a href="<?php //echo base_url().'uploads/student_image/'.  $student['file_name'];?>"><button
