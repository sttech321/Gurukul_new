                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input class="form-control m-r-10" name="birthday" type="date" value="2018-08-19"
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="alert alert-primary"><?php echo $this->lang->line('contact_information'); ?>
                            </div>
                            <hr>
...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-info">
            <div class="panel-heading"> <i class="fa fa-list"></i>&nbsp;&nbsp;<?php echo $this->lang->line('list_teacher'); ?>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- <a href="<?php //echo base_url().'uploads/teacher_image/'.  $teacher['file_name'];?>"><button
