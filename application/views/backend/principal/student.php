		...
		<div class="panel panel-info">
			<div class="panel-heading"><?php echo $this->lang->line('new_student'); ?>
				<div class="pull-right"><a href="#" data-perform="panel-collapse"><i
							class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo $this->lang->line('add_new_student_here'); ?><i
				...
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="alert alert-primary">
								<?php echo $this->lang->line('personal_information'); ?></div>
							<hr>
							<div class="form-group">
								<label class="col-md-12"
									for="example-text"><?php echo $this->lang->line('student_name'); ?></label>
								<div class="col-sm-12">
									<input type="text" class="form-control" id="name" name="name" required>
									<input type="text" class="form-control"
										value="<?php echo substr(md5(uniqid(rand(), true)), 0, 7); ?>"
										name="student_number" readonly="true">
							...
							<div class="form-group">
								...
								<div class="col-sm-12">
									<input class="form-control m-r-10" id="dob" name="dob" type="date"
										value="2018-08-19" id="example-date-input" required>
									<span class="text-danger" id="dob_error"></span>
								</div>
							</div>

							<label for="teacher"><?php echo $this->lang->line('select_teacher'); ?>:</label>
								...
								<div class="col-md-6">
									<select name="country" id="countrys" class="form-control">
										...
										<option value="<?php echo $country['id']; ?>"
											<?php echo ($students[0]['country'] == $country['id']) ? 'selected' : ''; ?>>
							...
							<div class="form-group">
								<label class="col-md-12"
									for="example-text"><?php echo $this->lang->line('address'); ?></label>
								<div class="col-sm-12">
							...
							<div class="form-group">
								<label class="col-md-12"
									for="example-text"><?php echo $this->lang->line('phone'); ?></label>
								<div class="col-sm-12">
							...
							<div class="form-group">
								<label class="col-md-12"
									for="example-text"><?php echo $this->lang->line('email'); ?></label>
								<div class="col-sm-12">
							...
							<div class="form-group">
								<label class="col-md-12"
									for="example-text"><?php echo $this->lang->line('password'); ?></label>
								<div class="col-sm-12">
							...
							<div class="form-group">
								<label class="col-md-12"
									for="example-text"><?php echo $this->lang->line('aadhaar_card'); ?></label>
								<div class="col-sm-12">
									<input type="number" class="form-control" id="aadhaar" name="aadhaar" value=""
										required>
							...
							<div class="form-group">
								<label class="col-md-12"
									for="example-text"><?php echo $this->lang->line('add_class'); ?></label>
								<div class="col-sm-12">
							...
							<hr>
							<div class="alert alert-primary"><?php echo $this->lang->line('father_information'); ?>
							</div>
							<hr>

							<div class="form-group">
								<label class="col-md-12"
									for="example-text"><?php echo $this->lang->line('father_name'); ?></label>
								<div class="col-sm-12">
							...
							<div class="form-group">
								<label class="col-md-12"
									for="example-text"><?php echo $this->lang->line('father_date_of_birth'); ?></label>
								<div class="col-sm-12">
									<input class="form-control m-r-10" name="father_dob" id="father_dob" type="date"
										value="2018-08-19" id="example-date-input" required>
						...
						<div class="col-sm-6">
							<div class="form-group">
								<label class="col-md-12"
									for="example-text"><?php echo $this->lang->line('father_aadhaar'); ?></label>
								<div class="col-sm-12">
									<input type="number" class="form-control" id="father_aadhaar"
										name="father_aadhaar" value="" required>
							...
							<div class="form-group">
								<label class="col-md-12"
									for="example-text"><?php echo $this->lang->line('father_address'); ?></label>
								<div class="col-sm-12">
									<input type="text" class="form-control" name="father_aaddress" value=""
										required>
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-md-12"
									for="example-text"><?php echo $this->lang->line('father_mobile_number'); ?></label>
								<div class="col-sm-12">
									<input type="number" class="form-control" id="father_mobile_number"
										name="father_mobile_number" value="" required>
							...
							<div class="form-group">
								<label class="col-md-12"
									for="example-text"><?php echo $this->lang->line('father_profession'); ?></label>
								<div class="col-sm-12">
									<input type="text" class="form-control" name="father_profession" value=""
										required>
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-md-12"
									for="example-text"><?php echo $this->lang->line('father_gotra'); ?></label>
								<div class="col-sm-12">
							...
							<div class="form-group">
								<label class="col-md-12"
									for="example-text"><?php echo $this->lang->line('father_varna'); ?></label>
								<div class="col-sm-12">
							...
							<hr>
							<div class="alert alert-primary"><?php echo $this->lang->line('mother_information'); ?>
							</div>
							<hr>

							<div class="form-group">
								<label class="col-md-12"
									for="example-text"><?php echo $this->lang->line('mother_name'); ?></label>
								<div class="col-sm-12">
							...
							<div class="form-group">
								<label class="col-md-12"
									for="example-text"><?php echo $this->lang->line('mother_date_of_birth'); ?></label>
								<div class="col-sm-12">
									<input class="form-control m-r-10" name="mother_dob" id="mother_dob" type="date"
										value="2018-08-19" id="example-date-input" required>
							...
							<div class="form-group">
								<label class="col-md-12"
									for="example-text"><?php echo $this->lang->line('mother_aadhaar'); ?></label>
								<div class="col-sm-12">
									<input type="number" class="form-control" id="mother_aadhaar"
										name="mother_aadhaar" value="" required>
							...
							<div class="form-group">
								<label class="col-md-12"
									for="example-text"><?php echo $this->lang->line('mother_address'); ?></label>
								<div class="col-sm-12">
									<input type="text" class="form-control" name="mother_aaddress" value=""
										required>
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-md-12"
									for="example-text"><?php echo $this->lang->line('mother_mobile_number'); ?></label>
								<div class="col-sm-12">
									<input type="number" class="form-control" id="mother_mobile_number"
										name="mother_mobile_number" value="" required>
							...
							<div class="form-group">
								<label class="col-md-12"
									for="example-text"><?php echo $this->lang->line('mother_profession'); ?></label>
								<div class="col-sm-12">
									<input type="text" class="form-control" name="mother_profession" value=""
										required>
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-md-12"
									for="example-text"><?php echo $this->lang->line('mother_gotra'); ?></label>
								<div class="col-sm-12">
							...
							<div class="form-group">
								<label class="col-md-12"
									for="example-text"><?php echo $this->lang->line('mother_varna'); ?></label>
								<div class="col-sm-12">
					...
					<div class="form-group">
						<button type="submit" class="btn btn-primary btn-rounded btn-block btn-sm"> <i
								class="fa fa-plus"></i>&nbsp;<?php echo $this->lang->line('add_student'); ?></button>
	...
	<div class="col-sm-12">
		<div class="panel panel-info">
			<div class="panel-heading"> <i
					class="fa fa-list"></i>&nbsp;&nbsp;<?php echo $this->lang->line('list_students'); ?></div>
					...
					<table id="example23" class="display nowrap" cellspacing="0" width="100%">
						<thead>
							<tr>
								...
								<th>
									<div><?php echo $this->lang->line('role'); ?></div>
								</th>
								<th>
								...
								<th>
									<div><?php echo $this->lang->line('option'); ?></div>
								</th>
							</tr>
						</thead>
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<a onclick="showAjaxModal('<?php echo base_url();?>modal/popup/edit_student/<?php echo $student['student_id'];?>')"
...
jQuery(document).ready(function($) {
    ...
    $('#father_aadhaar').on('input', function() {
        validateField('#father_aadhaar', '#father_aadhaar_error',
            'Father\'s Aadhaar must be 12 digits.',
            function(value) {
                return /^\d{12}$/.test(value);
            });
    });
    ...
    $('#father_mobile_number').on('input', function() {
        validateField('#father_mobile_number', '#father_mobile_number_error',
            'Father\'s Mobile must be 10 digits.',
            function(value) {
    ...
    $('#mother_aadhaar').on('input', function() {
        validateField('#mother_aadhaar', '#mother_aadhaar_error',
            'Mother\'s Aadhaar must be 12 digits.',
            function(value) {
                return /^\d{12}$/.test(value);
            });
    });
    ...
    $('#mother_mobile_number').on('input', function() {
        validateField('#mother_mobile_number', '#mother_mobile_number_error',
            'Father\'s Mobile must be 10 digits.',
            function(value) {
                return /^\d{10}$/.test(value);
            });
    ...
    $('#email').on('input', function() {
        validateField('#email', '#email_error', 'Email is required and must be valid.', function(
        value) {
    ...
    $('#father_dob').on('input', function() {
        validateRequiredField('#father_dob', '#father_dob_error',
            'Father\'s Date of Birth is required.');
    });

    $('#mother_dob').on('input', function() {
        validateRequiredField('#mother_dob', '#mother_dob_error',
