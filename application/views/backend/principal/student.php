...
<a href="#" onclick="confirm_modal('<?php echo base_url();?>principal/student/delete/<?php echo $student['student_id'];?>');"><button type="button" class="btn btn-danger btn-circle btn-xs"><i class="fa fa-times"></i></button></a>
