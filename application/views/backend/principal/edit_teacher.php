...
?>
            ...
            <div class="row">
                    ...
                    <?php echo form_open(base_url() . 'principal/teacher/update/'. $row['teacher_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
                        <label class="col-sm-12"><?php echo $this->lang->line('modern_education_qualifications'); ?>*</label>
                        <div class="col-sm-12">
                    ...
                    <div class="col-sm-6">
                        <div class="white-box">
                            <!-- <h3 class="box-title"><?php //echo get_phrase('account_information');?></h3> -->
                                ...
                                <div class="form-group">
                                    <label class="col-md-12" for="example-gotra"><?php echo $this->lang->line('gotra'); ?>*</span>
                                    </label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12" for="example-varna"><?php echo $this->lang->line('varna'); ?>*</span>
                                    </label>
                                    <div class="col-md-12">
                               <input type="text" id="example-varna" name="varna" class="form-control" value="<?php echo $row['varna']; ?>" required>
								 ...
								 <div class="form-group">
                                    <label class="col-md-12" for="inurl"><?php echo $this->lang->line('varna'); ?></span>
                                    </label>
                                    <div class="col-md-12">
                        ...
                        <div class="white-box">
                            <h3 class="box-title"><?php echo $this->lang->line('aadhaar'); ?></h3>
                                ...
                                <div class="form-group">
                                    <label class="col-md-12" for="furl"><?php echo $this->lang->line('aadhaar'); ?>*</span>
                                    </label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12" for="turl"><?php echo $this->lang->line('guru_name'); ?>*</span>
                                    </label>
                                    <div class="col-md-12">
...
<div class="form-group">
<button type="submit" class="btn btn-info btn-block btn-rounded btn-sm"><i class="fa fa-edit"></i>&nbsp;&nbsp;<?php echo $this->lang->line('update_teacher'); ?></button>
</div>
                <?php echo form_close();?>
</div>
</div>
