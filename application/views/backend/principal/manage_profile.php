		...
		<div class="panel panel-info">
			...
			<div class="panel-body table-responsive">
				...
				<div class="form-group"> 
					 ...
					 <img id="blah" src="<?php echo $this->crud_model->get_image_url('principal', $row['principal_id']); ?>" alt="" height="200" width="200"/>
					</div>
					</div>	
...
<div class="col-sm-5">
<div class="panel panel-info">
<div class="panel-heading"> <i class="fa fa-list"></i>&nbsp;&nbsp;<?php echo $this->lang->line('change_password'); ?></div>
...
<?php echo form_open(base_url() . 'principal/manage_profile/change_password', array('class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top', 'enctype' => 'multipart/form-data'));
        ?>			
				...
				<div class="form-group">
					<label class="col-md-12" for="example-text"><?php echo $this->lang->line('confirm_password'); ?></label>
					<div class="col-sm-12">
				...
				<div class="form-group">
                     <button class="btn btn-block btn-info btn-rounded btn-sm"><i class="fa fa-save"></i>&nbsp;<?php echo $this->lang->line('change_password'); ?></button>
