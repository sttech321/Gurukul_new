<div class="row">
                    <div class="col-sm-5">
				  	<div class="panel panel-info">
                            <div class="panel-heading"> <i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo $this->lang->line('add_section'); ?></div>
...
<!----CREATION FORM STARTS---->
                    ...
                    <div class="col-sm-12">
								...
								<div class="form-group">
                 	<label class="col-md-12" for="example-text"><?php echo $this->lang->line('nick_name'); ?></label>
                    <div class="col-sm-12">
                    ...
                    <div class="form-group">
                    <button type="submit" class="btn btn-info btn-block btn-rounded btn-sm"><i class="fa fa-book"></i>&nbsp;<?php echo $this->lang->line('add_section'); ?></button>
					</div>
			...
			<!----CREATION FORM ENDS-->
                    ...
                    <div class="col-sm-7">
				  	<div class="panel panel-info">
                            <div class="panel-heading"> <i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo $this->lang->line('list_section'); ?></div>
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body table-responsive">
                	...
                	<thead>
                		<tr>
                    		<th><div>#</div></th>
                    		<th><div><?php echo $this->lang->line('class_name'); ?></div></th>
                    		<th><div><?php echo $this->lang->line('nick_name'); ?></div></th>
                    		<th><div><?php echo $this->lang->line('teacher'); ?></div></th>
                    		<th><div><?php echo $this->lang->line('options'); ?></div></th>
						</tr>
					</thead>
                    <tbody>
