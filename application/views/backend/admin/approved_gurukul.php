                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-info">
                            <div class="panel-heading"><?php echo $this->lang->line('new_school');?>
                                <div class="pull-right"><a href="#" data-perform="panel-collapse"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo $this->lang->line('add_new_school_here');?><i class="btn btn-info btn-xs"></i></a> <a href="#" data-perform="panel-dismiss"></a> </div>
                            </div>
    ...
    <div class="col-sm-6">
                ...
                <div class="col-12 col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="emailid" name="email" placeholder="<?php echo $this->lang->line('email');?>" required>
            ...
            <div class="row">
                    <div class="col-sm-12">
				  	<div class="panel panel-info">
                            <div class="panel-heading"> <i class="fa fa-list"></i>&nbsp;&nbsp;<?php echo $this->lang->line('list_students');?>
