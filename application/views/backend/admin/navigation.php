...
<div class="sidebar-nav navbar-collapse slimscrollsidebar">
    <ul class="nav" id="side-menu">
        ...
        <li class="user-pro">
            ...
            <ul class="nav nav-second-level">
                ...
                <li><a href="javascript:void(0)"><i class="ti-email"></i>
                        <?php echo $this->lang->line('inbox'); ?></a></li>
                <li><a href="javascript:void(0)"><i class="ti-settings"></i>
                        <?php echo $this->lang->line('account_setting'); ?></a></li>
        ...
        <li> <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-mortar-board" data-icon="7"></i>
                <span class="hide-menu"> <?php echo $this->lang->line('manage_academics');?> <span
    ...
    ?> ">
        ...
        <li> <a href="#" class="waves-effect"><i data-icon="&#xe006;" class="fa fa-download p-r-10"></i> <span
                    class="hide-menu"><?php echo $this->lang->line('gurukul_registration');?><span
                        class="fa arrow"></span></span></a>
    ...
    ?> ">
        ...
        <li class="staff"> <a href="javascript:void(0);" class="waves-effect"><i data-icon="&#xe006;"
                    ...
                    class="hide-menu"><?php echo $this->lang->line('manage_employees');?><span
                        class="fa arrow"></span></span></a>
        ...
        <li class="student"> <a href="#" class="waves-effect"><i data-icon="&#xe006;"
                    ...
                    class="hide-menu"><?php echo $this->lang->line('manage_students');?><span
                        class="fa arrow"></span></span></a>
...
<li class="<?php //if ($page_name == 'studentHouse') echo 'active'; ?> ">
                <a href="<?php //cho base_url(); ?>studenthouse/studentHouse">
                <i class="fa fa-angle-double-right p-r-10"></i>
...
<li class="<?php //if ($page_name == 'socialCategory') echo 'active'; ?> ">
        ...
        <!-- <li class="attendance"> <a href="#" class="waves-effect"><i data-icon="&#xe006;"
                    ...
                    class="hide-menu"><?php //echo $this->lang->line('manage_attendance');?><span
                        class="fa arrow"></span></span></a>
    ...
    ">
        ...
        <li class=" <?php //if($page_name == 'parent')echo 'active';?>">
            <a href="<?php //echo base_url();?>admin/parent">
                ...
                <span class="hide-menu"><?php //echo $this->lang->line('manage_parents');?></span>
            </a>
        </li> -->
        <?php //endif;?>
        <!---  Permission for Admin Download Page  ends here ------>
        ...
        <!-- <li> <a href="#" class="waves-effect"><i data-icon="&#xe006;" class="fa fa-university p-r-10"></i> <span
                    class="hide-menu"><?php //echo $this->lang->line('class_information');?><span
                        class="fa arrow"></span></span></a>
    ...
    ?>">
        ...
        <li> <a href="#" class="waves-effect"><i data-icon="&#xe006;" class="fa fa-medkit p-r-10"></i> <span
                    class="hide-menu"><?php //echo $this->lang->line('manage_exams');?><span
                        class="fa arrow"></span></span></a>
...
?>">
        ...
        <!-- <li> <a href="#" class="waves-effect"><i data-icon="&#xe006;" class="fa fa-bar-chart-o p-r-10"></i>
                <span class="hide-menu"><?php //echo $this->lang->line('student_scores');?><span
                        class="fa arrow"></span></span></a>
    ...
    ?>">
        ...
        <!-- <li class="collect_fee"> <a href="#" class="waves-effect"><i data-icon="&#xe006;" -->
                    <!-- class="fa fa-paypal p-r-10"></i> <span class="hide-menu">
                    <?php //echo $this->lang->line('fee_collection');?>
    ...
    <!-- "> -->
        ...
        <!-- <li> <a href="#" class="waves-effect"><i data-icon="&#xe006;" class="fa fa-university p-r-10"></i> <span -->
                    <!-- class="hide-menu"> -->
                    <?php //echo $this->lang->line('hostel_information');?>
                    <!-- <span
                        class="fa arrow"></span></span></a> -->
            <!-- <ul class=" nav nav-second-level -->
            <?php
...
<!-- 
        ...
        <li> <a href="#" class="waves-effect"><i data-icon="&#xe006;" class="fa fa-car p-r-10"></i> <span
                    class="hide-menu"><?php echo $this->lang->line('transportation');?><span
                        class="fa arrow"></span></span></a>
    ...
    ?>">
        ...
        <!-- <li> <a href="#" class="waves-effect"><i data-icon="&#xe006;" class="fa fa-bar-chart-o p-r-10"></i>
                <span class="hide-menu"><?php //echo $this->lang->line('generate_reports');?><span
                        class="fa arrow"></span></span></a>
        ...
        <li> <a href="#" class="waves-effect"><i data-icon="&#xe006;" class="fa fa-cubes p-r-10"></i> <span
                    class="hide-menu"><?php //echo $this->lang->line('role_managements');?><span
                        class="fa arrow"></span></span></a>
