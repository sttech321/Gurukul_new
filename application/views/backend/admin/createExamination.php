<div class="row">
    <div class="col-sm-5">
        <div class="panel panel-info">
            <div class="panel-heading"> <i
                    class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo $this->lang->line('add_exam'); ?></div>
            ...
            <div class="panel-body table-responsive">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input class="form-control m-r-10" name="timestamp" type="date"
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-block btn-info btn-rounded btn-sm "><i
                            class="fa fa-plus"></i>&nbsp;<?php echo $this->lang->line('add_exam'); ?></button>
                </div>
                <?php echo form_close();?>
            </div>
        </div>
    ...
    <div class="col-sm-7">
        <div class="panel panel-info">
            <div class="panel-heading"> <i
                    class="fa fa-list"></i>&nbsp;&nbsp;<?php echo $this->lang->line('list_exam'); ?></div>
                    ...
                    foreach ($exams as $key => $exam): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a onclick="showAjaxModal('<?php echo base_url();?>modal/popup/edit_exam/<?php echo $exam['exam_id'];?>')"
                                        class="btn btn-info btn-circle btn-xs"><i class="fa fa-edit"></i></a>
                                    <a href="<?php echo base_url();?>admin/createExamination/delete/<?php echo $exam['exam_id'];?>"
