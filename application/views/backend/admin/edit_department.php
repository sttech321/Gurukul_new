    ...
    <div class="col-sm-12">
        <div class="panel panel-info">
            <div class="panel-heading"> <i
                    class="fa fa-edit"></i>&nbsp;&nbsp;<?php echo $this->lang->line('edit_department');?></div>
            <div class="panel-body table-responsive">
                ...
                <span id="designation">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <button type="button" class="btn btn-danger btn-xs btn-circle"
                                onclick="deleteParentElement(this, <?php echo $row2['designation_id']; ?>)">
                    ...
                    <span id="designation_input">
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <button type="button" class="btn btn-danger btn-xs btn-circle"
                                    onclick="deleteNewParentElement(this)">
                                    <i class="fa fa-times"></i>
                                </button>
                            </div>
                        </div>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-8">
                        <button type="button" class="btn btn-info btn-rounded btn-sm" onClick="add_designation()">
                            <?php echo $this->lang->line('add_designation'); ?>
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-success btn-block btn-rounded btn-sm"> <i
                            class="fa fa-plus"></i>&nbsp; <?php echo $this->lang->line('edit_department'); ?></button>
                </div>
                <?php echo form_close(); ?>
            </div>
        </div>
...
$(document).ready(function() {
    ...
    $(add_button).click(function(e) { //on add input button click
        ...
        $(wrapper).append(
            '<div class="col-sm-6"><input type="text" class="form-control" name="designation[]" value="" placeholder="designation" id="designation"></div>'
            ); //add input box
