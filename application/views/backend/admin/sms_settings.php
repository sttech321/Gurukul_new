<div class="row">
		...
		<div class="panel panel-info">
            ...
            <?php echo form_open(base_url() . 'smssetting/sms_settings/sms_active' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                ...
                <div class="form-group">
                        <label class="col-md-12" for="example-text"><?php echo $this->lang->line('select_sms_gateway');?></label>
                <div class="col-sm-12">
    ...
    <div class="row">
                    <div class="col-sm-6">
				  	<div class="panel panel-info">
                            <div class="panel-heading"> <i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo $this->lang->line('clickatell');?> 
                            

    <?php if($active == 'clickatell'):?>
    <span class="label label-success" style="color:white"><?php echo $this->lang->line('active');?></span>
    <?php endif;?>
...
<?php echo form_open(base_url() . 'smssetting/sms_settings/clickatell' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                ...
                <div class="form-group">
                 	<label class="col-md-12" for="example-text"><?php echo $this->lang->line('clickatell_username');?></label>
                    <div class="col-sm-12">
                ...
                <div class="form-group">
                 	<label class="col-md-12" for="example-text"><?php echo $this->lang->line('clickatell_password');?></label>
                    <div class="col-sm-12">
                ...
                <div class="form-group">
                 	<label class="col-md-12" for="example-text"><?php echo $this->lang->line('clickatell_apikey');?></label>
                    <div class="col-sm-12">
...
<?php echo form_open(base_url() . 'smssetting/sms_settings/msg91' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                ...
                <div class="form-group">
                 	<label class="col-md-12" for="example-text"><?php echo $this->lang->line('msg91_authentication_key');?></label>
                    <div class="col-sm-12">
                ...
                <div class="form-group">
                 	<label class="col-md-12" for="example-text"><?php echo $this->lang->line('msg91_sender_id');?></label>
                    <div class="col-sm-12">
                ...
                <div class="form-group">
                 	<label class="col-md-12" for="example-text"><?php echo $this->lang->line('msg91_route');?></label>
                    <div class="col-sm-12">
                ...
                <div class="form-group">
                 	<label class="col-md-12" for="example-text"><?php echo $this->lang->line('msg91_country_code');?></label>
                    <div class="col-sm-12">
