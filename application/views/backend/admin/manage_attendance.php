    ...
    <div class="col-sm-12">
        <div class="panel panel-info">
            <div class="panel-heading"> <i
                    class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo $this->lang->line('attendence'); ?></div>
            <div class="panel-body table-responsive">
                ...
                <div class="form-group">
                    <label class="col-md-12" for="example-text"><?php echo $this->lang->line('section'); ?></label>
                    <div class="col-sm-12">
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-info btn-block btn-rounded btn-sm"><i
                            class="fa fa-search"></i>&nbsp;<?php echo $this->lang->line('get_student'); ?></button>
                </div>
        ...
        <div class="panel panel-info">
            <div class="panel-body table-responsive">
                ...
                <form
                    ...
                    <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <div><?php echo $this->lang->line('sex'); ?></div>
                                </th>
                                <th>
                                    <div><?php echo $this->lang->line('roll'); ?></div>
                                </th>
                                <th>
                                    <div><?php echo $this->lang->line('status'); ?></div>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-info btn-block btn-rounded btn-sm"><i
                                class="fa fa-plus"></i>&nbsp;<?php echo $this->lang->line('save'); ?></button>
                    </div>
