            ...
            <div class="panel-wrapper collapse in" aria-expanded="true">
                <div class="panel-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            ...
                            <select name="principal_id" id="principal_id" class="form-control">
                                <option value=""><?php echo $this->lang->line('select_gurukul');?></option>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="white-box">
                                <h3 class="box-title"><?php echo $this->lang->line('account_inforomation');?></h3>
                                ...
                                <div class="form-group">
                                    <label class="col-md-12"
                                        for="inurl"><?php echo $this->lang->line('surname');?></span>
                                    </label>
                                    <div class="col-md-12">
                        ...
                        <div class="col-sm-6">
                            <div class="white-box">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12"
                                        for="furl"><?php echo $this->lang->line('aadhaar_card');?>*</span>
                                    </label>
                                    <div class="col-md-12">
