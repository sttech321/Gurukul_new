    ...
    <div class="col-sm-12">
        <div class="panel panel-info">
            <div class="panel-heading"> <i
                    class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo $this->lang->line('enter_student_score'); ?></div>
            <div class="panel-body table-responsive">
                    ...
                    <div class="col-sm-12">
                        <select name="exam_id" class="form-control select2">
                            ...
                            <option value="<?php echo $exam['exam_id'];?>"
                                <?php if($exam_id == $exam['exam_id']) echo 'selected="selected"' ;?>>
                    ...
                    <div class="col-sm-12">
                        <select name="class_id" class="form-control select2" onchange="show_students(this.value)">
                            ...
                            <option value="<?php echo $class['class_id'];?>"
                                <?php if($class_id == $class['class_id']) echo 'selected="selected"' ;?>>Class:
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        <select name="" id="student_id_0"
                            style="display:<?php if(isset($student_id) && $student_id > 0) echo 'none'; else echo 'block';?>"
                            class="form-control">
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-info btn-block btn-rounded btn-sm"><i
                            class="fa fa-search"></i>&nbsp;<?php echo $this->lang->line('get_details'); ?></button>
                </div>
    ...
    <div class="col-sm-12">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table">
                    <thead>
                        <tr>
                            ...
                            <td><?php echo $this->lang->line('ist_score'); ?></td>
                            <td><?php echo $this->lang->line('2nd_score'); ?></td>
                            <td><?php echo $this->lang->line('3rd_score'); ?></td>
                            <td><?php echo $this->lang->line('exam_score'); ?></td>
        ...
        ?>
                ...
                <h5 id="error_message" class="alert alert-warning" style="display:none">
                    <?php echo $this->lang->line('class_score_limit'); ?></h5>
                <button type="submit" class="btn btn-sm btn-rounded btn-block  btn-info"><i
                        class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('update_marks');?></button>
