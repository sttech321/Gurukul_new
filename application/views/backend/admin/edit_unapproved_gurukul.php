                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="mobile_number" name="mobile_number"
                                    ...
                                    value="<?php echo $principal['phone'];?>" required>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" id="emailid" name="email"
                                    ...
                                    value="<?php echo $principal['email'];?>" required>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mx-0">
                                <div class="col-md-6">
                                    <label for="country" class=""><?php echo  $this->lang->line('country'); ?></label>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="col-sm-12">
                                <label clas s="form-group"><?php echo  $this->lang->line('browse_image'); ?>*</label>
