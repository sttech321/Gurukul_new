<div class="row">
    <div class="col-sm-5">
        <div class="panel panel-info">
            <div class="panel-heading"> <i
                    class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo $this->lang->line('add_subject'); ?></div>
                ...
                <div class="panel-body table-responsive">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-info btn-block btn-rounded btn-sm"><i
                                class="fa fa-book"></i>&nbsp;<?php echo $this->lang->line('add_subject'); ?></button>
                    </div>
    ...
    <div class="col-sm-7">
        <div class="panel panel-info">
            <div class="panel-heading"> <i
                    class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo $this->lang->line('list_subject'); ?></div>
            <div class="panel-wrapper collapse in" aria-expanded="true">
                <div class="panel-body table-responsive">
                    ...
                    <button type="button" id="find"
                        class="btn btn-success btn-rounded btn-sm btn-block"><?php echo $this->lang->line('get_subject'); ?></button>
                    <hr>
