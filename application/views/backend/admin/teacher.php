                    ...
                    <div class="panel panel-info">
                        <div class="panel-heading"><?php echo $this->lang->line('new_teacher'); ?>
                            <div class="pull-right"><a href="#" data-perform="panel-collapse"><i
                                        class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo $this->lang->line('add_new_teacher_here'); ?><i
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-12"
                                                for="example-text"><?php echo $this->lang->line('gurukul_name'); ?></label>
                                            <div class="col-sm-12">
                                                ...
                                                <input type="hidden" name="principal_id"
                                                    value="<?php echo $this->session->userdata('principal_id'); ?>">
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-12"
                                                for="example-text"><?php echo $this->lang->line('teacher_name'); ?></label>
                                            <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input class="form-control m-r-10" name="birthday" type="date"
                                                    value="2018-08-19" id="date_of_birth" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="password" class="form-control" id="password" name="password"
                                                    value="" onkeyup="CheckPasswordStrength(this.value)" required>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="alert alert-primary"><?php echo $this->lang->line('contact_information'); ?></div>
                                        <hr>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="number" class="form-control" id="mobile_number" name="phone" value=""
                                                    required>
                                                <span class="text-danger" id="mobile_number_error"></span>
                                            </div>
                                        </div>

                                        <div class="alert alert-primary"><?php echo $this->lang->line('spiritual_details'); ?>
                                        </div>
                                        <hr>
                                        <div class="form-group">
                                            <label class="col-md-12"
                                        ...
                                        <div class="alert alert-primary"><?php echo $this->lang->line('skills_education'); ?>
                                        </div>
                                        <hr>
                                        <div class="form-group">
                                            <label class="col-md-12"
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-12"
                                                for="example-text"><?php echo $this->lang->line('modern_education_qualifications'); ?></label>
                                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary btn-rounded btn-block btn-sm"> <i
                                            class="fa fa-plus"></i>&nbsp;<?php echo $this->lang->line('add_teacher'); ?></button>
                ...
                <div class="col-sm-12">
                    <div class="panel panel-info">
                        <div class="panel-heading"> <i
                                class="fa fa-list"></i>&nbsp;&nbsp;<?php echo $this->lang->line('list_teacher'); ?></div>
                                ...
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>
                                                <div><?php echo $this->lang->line('teacher_id'); ?></div>
                                            </th>
                                            <th>
...
$('#date_of_birth').on('input', function() {
    validateRequiredField('#date_of_birth', '#date_of_birth_error', 'Date of Birth is required.',
        function(value) {
            return value !== '';
        });
});
