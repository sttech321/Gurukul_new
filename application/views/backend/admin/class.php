<div class="row">
    <div class="col-sm-5">
        <div class="panel panel-info">
            <div class="panel-heading"> <i
                    class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo $this->lang->line('add_class'); ?></div>
                ...
                <div class="panel-body table-responsive">
                    ...
                    <div class="form-group">
                        <label class="col-md-12"
                            for="example-text"><?php echo $this->lang->line('name_numeric'); ?></label>
                        <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-info btn-block btn-rounded btn-sm"><i
                                class="fa fa-book"></i>&nbsp;<?php echo $this->lang->line('add_class'); ?></button>
                    </div>
    ...
    <div class="col-sm-7">
        <div class="panel panel-info">
            <div class="panel-heading"> <i
                    class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo $this->lang->line('list_class'); ?></div>
            <div class="panel-wrapper collapse in" aria-expanded="true">
                <div class="panel-body table-responsive">
                    ...
                    <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <div><?php echo $this->lang->line('class_name'); ?></div>
                                </th>
                                <th>
                                    <div><?php echo $this->lang->line('name_numeric'); ?></div>
                                </th>
                                <th>
                                    <div><?php echo $this->lang->line('teacher'); ?></div>
                                </th>
                                <th>
                    ...
                    foreach($classes as $key => $classes):?>
                            <tr>
                                ...
                                <td><?php echo $this->crud_model->get_type_name_by_id('teacher', $classes['teacher_id']);?>
                                </td>
                                <td>

                                    <a href="#"
                                        onclick="showAjaxModal('<?php echo base_url();?>modal/popup/edit_class/<?php echo $classes['class_id'];?>');"><button
                                            type="button" class="btn btn-info btn-circle btn-xs"><i
                                                class="fa fa-pencil"></i></button></a>
                                    <a href="#"
                                        onclick="confirm_modal('<?php echo base_url();?>admin/classes/delete/<?php echo $classes['class_id'];?>');"><button
