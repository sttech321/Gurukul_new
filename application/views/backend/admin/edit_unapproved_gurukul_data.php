        ...
        <a href="#" onclick="confirm_modals('<?php echo base_url();?>admin/unapproved_gurukul/delete/<?php echo $principal['principal_id'];?>');"><button type="button" class="btn btn-danger btn-circle btn-xs"><i class="fa fa-times"></i></button></a>
